...
如果你對`cd`和`ls`等等指令不熟，請先看[這篇教學](../../Linux/Terminal-Common-Instruction/README.md)，
畢竟這會一直用到!
...
![cd to bin](./Screenshot/new%20cd%20to%20bin.png)
...
```
![compile](./Screenshot/compile.png?raw=true)
